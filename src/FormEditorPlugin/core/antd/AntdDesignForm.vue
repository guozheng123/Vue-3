...
<script lang="ts">
    ...
    import CodeEditor from '@/FormEditorPlugin/components/CodeEditor.vue';
    import ComponentGroup from '@/FormEditorPlugin/components/ComponentGroup.vue';
    ...
    import { copy } from '@/FormEditorPlugin/utils';
    import { CodeType, PlatformType } from '@/FormEditorPlugin/enums';
    import generateCode from '@/FormEditorPlugin/utils/generateCode';
    import { WidgetForm } from '@/FormEditorPlugin/config/antd';
    ...
    export default defineComponent({
        ...
        setup() {
            ...
            const handleGetData = async () => {
                const res = await state.generateFormRef.getData();
                console.log('handleGetData: ', res);
                // .then((res: any) => {
