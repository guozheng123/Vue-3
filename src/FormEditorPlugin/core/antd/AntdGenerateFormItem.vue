<template>
    <a-form-item v-if="element" :key="element.key" :label="element.label" :name="element.model">
        {{ element.model }}--{{ element.type }}
...
<script lang="ts">
    ...
    import RichTextEditor from '@/FormEditorPlugin/components/RichTextEditor.vue';
