...
<script setup lang="tsx" name="equipmentDebugging">
    ...
    import { withTpfTableSortColumn, withTpfTableSortDate } from '@/components/TpfTable/index';
    ...
    const pageCode = PageCodeEnum.fatPcInspectOrderInfo;
